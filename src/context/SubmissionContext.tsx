...
interface SubmissionContextType {
    ...
    addSubmission: (submission: Omit<Submission, 'id' | 'status' | 'submittedDate'>) => Submission;
    updateSubmissionStatus: (id: number, status: Submission['status']) => Submission | null;
...
export const SubmissionProvider: React.FC<SubmissionProviderProps> = ({ children }) => {
    ...
    const addSubmission = (submission: Omit<Submission, 'id' | 'status' | 'submittedDate'>) => {
